...
if feature_extraction_layer == 'block1':
    ...
    tensor_name = 'Mixed_5d'
elif feature_extraction_layer == 'block7':
    tensor_name = 'Mixed_5e'
    ...
    tensor_name = 'Mixed_6c'
elif feature_extraction_layer == 'block11':
    tensor_name = 'Mixed_6d'
elif feature_extraction_layer == 'block12':
    tensor_name = 'Mixed_6e'
elif feature_extraction_layer == 'block13':
    tensor_name = 'Mixed_6f'
elif feature_extraction_layer == 'block14':
    tensor_name = 'Mixed_6g'
elif feature_extraction_layer == 'block15':
    tensor_name = 'Mixed_6h'
elif feature_extraction_layer == 'block16':
    tensor_name = 'Mixed_7a'
elif feature_extraction_layer == 'block17':
    tensor_name = 'Mixed_7b'
elif feature_extraction_layer == 'block18':
    tensor_name = 'Mixed_7c'
elif feature_extraction_layer == 'block19':
    tensor_name = 'Mixed_7d'
elif feature_extraction_layer == 'block20':
    tensor_name = 'Logits'
...
with tf.Graph().as_default():
    ...
    with slim.arg_scope(inception_v4.inception_v4_arg_scope()):
        logits, end_points = inception_v4.inception_v4(processed_images, num_classes=1001, is_training=False)
    ...
    init_fn = slim.assign_from_checkpoint_fn(
        os.path.join(checkpoints_dir, 'inception_v4.ckpt'), slim.get_model_variables('InceptionV4'))
