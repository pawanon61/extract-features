...
image_size = inception_v2.inception_v2.default_image_size
...
with tf.Graph().as_default():
    ...
    with slim.arg_scope(inception_v2.inception_v2_arg_scope()):
        logits, end_points = inception_v2.inception_v2(processed_images, num_classes=1001, is_training=False)
    ...
    init_fn = slim.assign_from_checkpoint_fn(
        os.path.join(checkpoints_dir, 'inception_v2.ckpt'), slim.get_model_variables('InceptionV2'))
